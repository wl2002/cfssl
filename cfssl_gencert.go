...
Usage of gencert:
        ...
        cfssl gencert -ca cert -ca-key key [-f config] [-profile -profile] HOSTNAME CSRJSON
        cfssl gencert -remote remote_host [-f config] [-profile profile] [-label label] HOSTNAME CSRJSON
...
var gencertFlags = []string{"initca", "remote", "ca", "ca-key", "f", "profile", "label"}
